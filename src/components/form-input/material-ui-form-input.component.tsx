...
enum MaterialUIFormInputKind {
  PRIMARY = 'primary',
  SECONDARY = 'secondary',
  SUBSCRIBE = 'subscribe',
}

interface MaterialUIFormInputProps {
  kind?: MaterialUIFormInputKind;
}

const MaterialUIFormInput: React.FC<MaterialUIFormInputProps> = ({
  kind = MaterialUIFormInputKind.PRIMARY,
}) => {
  if (kind === MaterialUIFormInputKind.SECONDARY) {
    return (
  ...
  else if (kind === MaterialUIFormInputKind.SUBSCRIBE) {
    return (
...
export default MaterialUIFormInput;
